...
public class Calc_GUI implements ActionListener {
	...
	public JPanel ChapterPanel = new JPanel();
	public JPanel TopicPanel = new JPanel();
	public JPanel SubtopicPanel = new JPanel();
	public JPanel ButtonPanel = new JPanel();
	public JPanel DividerPanel = new JPanel();
	public JPanel IOPanel = new JPanel();
	@SuppressWarnings("rawtypes")
	public JComboBox ChapterComboBox = new JComboBox();
	@SuppressWarnings("rawtypes")
	public JComboBox TopicComboBox = new JComboBox();
	@SuppressWarnings("rawtypes")
	public JComboBox SubTopicComboBox = new JComboBox();
	public JTextArea ChapterTextArea = new JTextArea();
	public JTextArea TopicTextArea = new JTextArea();
	public JTextArea SubTopicTextArea = new JTextArea();
	public JTextArea IOTextArea = new JTextArea();
	public JScrollPane IOScrollPane = new JScrollPane();
	public JTextField IOTextField = new JTextField();
	public JButton EnterButton = new JButton();
	public JButton QuitButton = new JButton();
	public JButton CalcButton = new JButton();
	public JButton HideButton = new JButton();
	public Font IOTextAreaFont = new Font("",0,0);
	public Font IOTextFieldFont = new Font("",0,0);
	public Font ButtonFont = new Font("",0,0);
	public Font ComboBoxFont = new Font("",0,0);
	public Font TextAreaFont = new Font("",0,0);
	public Border CalcBorder = BorderFactory.createLineBorder(Color.BLACK,2);;
	...
	public double e;
	public int LengthE;
	public Set<Double> A = new TreeSet<Double>();
	public Set<Double> B = new TreeSet<Double>();
	public Set<Double> C = new TreeSet<Double>();
    ...
    public String DEM;
    public int i;
	public ActionListener[] Union =  new ActionListener[4];
	public ActionListener[] Intersection =  new ActionListener[4];
	public ActionListener[] Addition = new ActionListener[2];
	public ActionListener[] Subtraction = new ActionListener[2];
	public ActionListener[] Multiplication = new ActionListener[2];
	public ActionListener[] Division = new ActionListener[2];
	public ActionListener[] RationalAddition = new ActionListener[2];
	public ActionListener[] RationalSubtraction = new ActionListener[2];
	public ActionListener[] RationalMultiplication = new ActionListener[2];
	public ActionListener[] RationalDivision = new ActionListener[2];
	public ActionListener[] Exponentiation = new ActionListener[2];
	public ActionListener[] SimpleInterest = new ActionListener[3];
	public ActionListener[] CompoundInterest = new ActionListener[4];
	public ActionListener[] Logarithm = new ActionListener[2];
	public ActionListener[] EquilateralTrianglePerimeter= new ActionListener[1];
	public ActionListener[] EquilateralTriangleAreaSides = new ActionListener[1];
	public ActionListener[] EquilateralTriangleAreaBaseHeight = new ActionListener[2];
	public ActionListener[] IsoscelesTrianglePerimeter = new ActionListener[2];
	public ActionListener[] IsoscelesTriangleAreaSides = new ActionListener[2];
	public ActionListener[] IsoscelesTriangleAreaBaseHeight = new ActionListener[2];
	public ActionListener[] ScaleneTrianglePerimeter = new ActionListener[3];
	public ActionListener[] ScaleneTriangleAreaSides = new ActionListener[3];
	public ActionListener[] ScaleneTriangleAreaBaseHeight = new ActionListener[2];
	public ActionListener[] FullCircleArea = new ActionListener[1];
	public ActionListener[] FullCircleCircumference = new ActionListener[1];
	public ActionListener[] SemiCircleArea = new ActionListener[1];
	public ActionListener[] SemiCircleCircumference = new ActionListener[1];
	public ActionListener[] SemiCirclePerimeter = new ActionListener[1];
	public ActionListener[] RectangleArea = new ActionListener[2];
	public ActionListener[] RectanglePerimeter = new ActionListener[2];
	public ActionListener[] SquareArea = new ActionListener[1];
	public ActionListener[] SquarePerimeter = new ActionListener[1];
	public ActionListener[] RhombusArea = new ActionListener[2];
	public ActionListener[] RhombusPerimeter = new ActionListener[1];
	public ActionListener[] ParallelogramArea = new ActionListener[2];
	public ActionListener[] ParallelogramPerimeter = new ActionListener[2];
	public ActionListener[] KiteArea = new ActionListener[2];
	public ActionListener[] KitePerimeter = new ActionListener[2];
	public ActionListener[] CubeLateralSurfaceArea = new ActionListener[1];
	public ActionListener[] CubeTotalSurfaceArea = new ActionListener[1];
	public ActionListener[] CubeVolume = new ActionListener[1];
	public ActionListener[] CubePerimeter = new ActionListener[1];
	public ActionListener[] CuboidLateralSurfaceArea = new ActionListener[3];
	public ActionListener[] CuboidTotalSurfaceArea = new ActionListener[3];
	public ActionListener[] CuboidVolume = new ActionListener[3];
	public ActionListener[] CuboidPerimeter = new ActionListener[3];
	public ActionListener[] SphereSurfaceArea = new ActionListener[1];
	public ActionListener[] SphereVolume = new ActionListener[1];
	public ActionListener[] ConeLateralSurfaceArea = new ActionListener[2];
	public ActionListener[] ConeTotalSurfaceArea = new ActionListener[2];
	public ActionListener[] ConeVolume = new ActionListener[2];
	public ActionListener[] ConeSlantHeight = new ActionListener[2];
